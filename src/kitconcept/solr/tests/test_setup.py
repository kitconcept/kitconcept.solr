...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        if HAS_INSTALLER:
            self.assertTrue(self.installer.is_product_installed("kitconcept.solr"))
        else:
            self.assertTrue(self.installer.isProductInstalled("kitconcept.solr"))
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        if HAS_INSTALLER:
            self.assertFalse(self.installer.is_product_installed("kitconcept.solr"))
        else:
            self.assertFalse(self.installer.isProductInstalled("kitconcept.solr"))
